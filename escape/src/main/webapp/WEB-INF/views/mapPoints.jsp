...
<script>
   ...
   function getCampingDetail(detail){
      ...
      rightviewInfo.className = "place-content"
      rightviewInfo.id = "rightviewInfo"
      rightviewInfo.innerHTML = detail[0].cpName+"<br>"+detail[0].cpContents+"<br>"+detail[0].cpContents+"<br>"+detail[0].maAddress+"<br>"+detail[0].haName+"<br>"+detail[0].thName;
      rightviewInfo.style.cssText = 'background: red; width:100%; height:100%;'
