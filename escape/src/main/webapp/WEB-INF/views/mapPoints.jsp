...
<body onLoad="checkCa('C001'), getCampingPage('1','10','C001', '1000'), chooseCampingList('1','10','C001','1000'),init('${objName}')"/>
   ...
   <div id="basic">
      ...
      <select id="job" name="job" size="1">
         ...
         <option value="조아요순">찜순</option>
               ...
               <div id="listPoints">
                  <div id="mySideStore" onClick="delrecord(); checkCa('C003'); getCampingPage('1','10','C003', '1000');chooseCampingList('1','10','C003','1000');">카라반</div>
                  <div id="fishingPoint" onClick="delrecord(); checkCa('C002'); getCampingPage('1','10','C002', '1000');chooseCampingList('1','10','C002','1000');">글램핑</div>
                  <div id="camping" onClick="delrecord(); checkCa('C001'); getCampingPage('1','10','C001', '1000');chooseCampingList('1','10','C001','1000');">캠핑</div>
   ...
   /* kakao.maps.event.addListener(map, 'center_changed', function() {
      ...
      // 지도의 중심좌표를 얻어옵니다 
       ...
       searchAddrFromCoords(latlng, function(result, status) {
         if (status === kakao.maps.services.Status.OK) {
            getCampingList('C001', '1000', result[0].region_1depth_name)
         }
      });
 ...
 */
   ...
   function myMarker(locPosition, message, haName, caCode) {
      if (clickedoverlay) {
