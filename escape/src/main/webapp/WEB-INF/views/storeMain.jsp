...
<body onLoad= "init('${objName}'),initPage('${msg}')" />
		...
		<div id="basic">
			<div id="top">
				...
				<div id="box1">
		 			<div id="login1"><span class="top_menu" >${sessionInfo.srId}님</span>
		 			<input id="logOutButton" type = "button" value= "로그아웃" onClick="logOutMember('${sessionInfo.srId}','${sessionInfo.publicIp}','${sessionInfo.srCode}')"/></div>
			...
			<div id="mid">
				<div id="line1"></div>
				<div id="box2">
					<div id="fishing"><span onClick="getNewPageStore('${sessionInfo.srId}','','${sessionInfo.publicIp}','${sessionInfo.srCode}')" ><img id="fishing1" src='resources/images/map.png' onMouseOver="this.src='resources/images/fishingPoint1.png'" onmouseout="this.src='resources/images/map.png'"/></span></div>
					...
					<div id="camping" ><span onClick="getNewPageStore('${sessionInfo.srId}','mapPoints_store','${sessionInfo.publicIp}','${sessionInfo.srCode}')" ><img id="camping1" src='resources/images/tent.png' onMouseOver="this.src='resources/images/camping1.png'" onmouseout="this.src='resources/images/tent.png'"/></span></div>
