...
<body onLoad="getCampingList('C001', '1000'),getCampingPage('1','10','C001', '1000'),chooseCampingList('1','10','C001','1000'),init('${objName}')"/>
	...
	<div id="basic">
		...
		<div id="mid">
			<div id="leftList">
				<div id="listFilter"><input id="insert" type="button" value="등록" onClick="getNewPageStore('${sessionInfo.srId}','mapPoints_store','${sessionInfo.publicIp}','${sessionInfo.srCode}')"/>
					<label for="job"></label> 
