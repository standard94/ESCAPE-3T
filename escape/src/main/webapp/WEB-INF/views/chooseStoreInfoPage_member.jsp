...
<link rel="stylesheet" type="text/css" href="resources/css/chooseStoreInfoPage_logIn.css" />
			...
			<div id="mid">
				<div id="sideBar">
     			<div id="sideContents">
     				...
     				<div id="myRentalGps" class="menuTop"  onClick="getNewPageMember('${sessionInfo.mmId}','campingMap_member','${sessionInfo.publicIp}','${sessionInfo.mmCode}')">
     					<div class="text1" >ㅡ내 주변 렌탈업체 찾기
     					</div>
     				</div>
     		
     				
     				<div id="fishingRental" class="menuTop" onClick="getNewPageMember('${sessionInfo.mmId}','storeInfoPage2','${sessionInfo.publicIp}','${sessionInfo.mmCode}')">
     					<div class="text1">ㅡ낚시 렌탈업체
     					</div>
     				</div>
     				
     				<div id="campingRental" class="menuTop" onClick="getNewPageMember('${sessionInfo.mmId}','storeInfoPage2_member','${sessionInfo.publicIp}','${sessionInfo.mmCode}')">
