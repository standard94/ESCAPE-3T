   ...
   <div id="basic">
      ...
      <div id="mid">
           <div id="regForm">
              ...
              <form name="ajaxUploadForm" action="MultiPart2" method="post" enctype="multipart/form-data">
              <div id="file"><input type="file" name="files" multiple/></div>
              </form>
              
              <div id="posting"><input id="content" name="content" type="text" placeholder="글 쓰기"/></div>
