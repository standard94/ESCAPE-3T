...
<body onLoad="init('${objName}'),initPage('${msg}')">
		...
		<div id="basic">
			...
			<div id="mid">
				<div id="line1"></div>
				<div id="box2">
					<div id="fishing"><span onClick="getNewPageMember('${sessionInfo.mmId}','','${sessionInfo.publicIp}','${sessionInfo.mmCode}')"><img id="fishing1" src='resources/images/map.png' onMouseOver="this.src='resources/images/fishingPoint1.png'" onmouseout="this.src='resources/images/map.png'"/></span></div>
					...
					<div id="camping" ><span onClick="getNewPageMember('${sessionInfo.mmId}','mapPoints_member','${sessionInfo.publicIp}','${sessionInfo.mmCode}')" ><img id="camping1" src='resources/images/tent.png' onMouseOver="this.src='resources/images/camping1.png'" onmouseout="this.src='resources/images/tent.png'"/></span></div>
