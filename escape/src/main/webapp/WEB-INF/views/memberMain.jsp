		...
		<div id="basic">
			...
			<div id="mid">
				...
				<div id="box2">
					...
					<div id="camping" ><span onClick="getNewPageMember('${sessionInfo.mmId}','mapPoints')" ><img id="camping1" src='resources/images/tent.png' onMouseOver="this.src='resources/images/camping1.png'" onmouseout="this.src='resources/images/tent.png'"/></span></div>
