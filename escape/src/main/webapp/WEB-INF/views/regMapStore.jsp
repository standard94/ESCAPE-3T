		...
		<div id="mid">
     		<div id="regForm">
     			...
     			<div id="buttonDiv">
     				...
     				<button type="button" id="cancel" onClick="getNewPageStore('${sessionInfo.srId}','mapPoints_store')">취소</button>
     			</div>
     		</div>
		</div>
...
function insertDiv(result){
	...
	if(postCode.value != result[0].road_address.zone_no && address.value != result[0].road_address.address_name){
		postCode.value =  result[0].road_address.zone_no;
...
kakao.maps.event.addListener(map, 'click', function(mouseEvent) {
    searchDetailAddrFromCoords(mouseEvent.latLng, function(result, status) {
        if (status === kakao.maps.services.Status.OK) {
            ...
            var content = '<div class="bAddr" style="width:160%; height:100%;">' +
